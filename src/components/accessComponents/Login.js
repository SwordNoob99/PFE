            ...
            <div className="container-fluid h-custom">
              <div className="row d-flex justify-content-center align-items-center h-100">
                <div className="col-md-9 col-lg-6 col-xl-5">
                  <img className='image-login masked-overflow' src="https://wallpaperaccess.com/full/5216528.jpg" />
                ...
                <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                  <form onSubmit={(e) => this.handleSubmit(e)}>
                    ...
                    <div className="text-center text-lg-start mt-4 pt-2">
                      <button type="button" className="btn btn-primary btn-lg" style={{paddingLeft: '2.5rem', paddingRight: '2.5rem'}} onClick={(e) => handleSubmit(e)}>Login</button>
